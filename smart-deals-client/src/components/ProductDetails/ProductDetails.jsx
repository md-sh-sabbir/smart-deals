                        ...
                        <div className="modal-box">
                            ...
                            <form onSubmit={handleBidSubmit}>
                                <fieldset className="fieldset">
                                    ...
                                    <input type="text" className="input" placeholder="Name" name='name' defaultValue={user?.displayName} readOnly />
                                    <label className="label">Email</label>
                                    <input type="email" className="input" placeholder="Email" name='email' defaultValue={user?.email} />
                                    <label className="label">Bid</label>
                                    <input type="number" className="input" name='bid' placeholder="Your Bid" />
